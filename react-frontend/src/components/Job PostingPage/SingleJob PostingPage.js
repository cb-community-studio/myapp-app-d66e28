...
const SingleJob PostingPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("Job Posting")
            .get(urlParams.singleJob PostingId, { query: { $populate: [] }})
            .then((res) => {
                set_entity(res || {});
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                <div className="flex align-items-center justify-content-start">
                    ...
                    <h3 className="m-0">Job Posting</h3>
                </div>
                <p>Job Posting/{urlParams.singleJob PostingId}</p>
            </div>
...
export default connect(mapState, mapDispatch)(SingleJob PostingPage);
