...
const Benefits AdministrationCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        ...
        setLoading(true);
        try {
            const result = await client.service("Benefits Administration").patch(_entity._id, _data);
            props.onHide();
    ...
    return (
        <Dialog header="Edit Info" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div role="Benefits Administration-edit-dialog-component">
                <div>
...
export default connect(null, mapDispatch)(Benefits AdministrationCreateDialogComponent);
