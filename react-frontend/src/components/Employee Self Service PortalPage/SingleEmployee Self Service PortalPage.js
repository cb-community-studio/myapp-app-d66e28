...
const SingleEmployee Self Service PortalPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleEmployee Self Service PortalId, { query: { $populate: [] }})
            .then((res) => {
                set_entity(res || {});
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                <div className="flex align-items-center justify-content-start">
                    ...
                    <h3 className="m-0">Employee Self Service Portal</h3>
                </div>
                <p>Employee Self Service Portal/{urlParams.singleEmployee Self Service PortalId}</p>
            </div>
...
export default connect(mapState, mapDispatch)(SingleEmployee Self Service PortalPage);
