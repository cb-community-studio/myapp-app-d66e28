...
const Workforce Diversity And InclusiCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        ...
        setLoading(true);
        try {
            const result = await client.service("Workforce Diversity And Inclusi").patch(_entity._id, _data);
            props.onHide();
    ...
    return (
        <Dialog header="Edit Info" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div role="Workforce Diversity And Inclusi-edit-dialog-component">
                <div>
...
export default connect(null, mapDispatch)(Workforce Diversity And InclusiCreateDialogComponent);
