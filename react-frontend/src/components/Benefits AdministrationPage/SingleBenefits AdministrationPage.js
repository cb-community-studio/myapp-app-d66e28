...
const SingleBenefits AdministrationPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleBenefits AdministrationId, { query: { $populate: [] }})
            .then((res) => {
                set_entity(res || {});
            ...
            .catch((error) => {
                console.log({ error });
                props.alert({ title: "Benefits Administration", type: "error", message: error.message || "Failed get Benefits Administration" });
            });
    }, []);
    ...
    const goBack = () => {
        navigate("/Benefits Administration", { replace: true });
    };
    return (
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                <div className="flex align-items-center justify-content-start">
                    ...
                    <h3 className="m-0">Benefits Administration</h3>
                </div>
                <p>Benefits Administration/{urlParams.singleBenefits AdministrationId}</p>
            </div>
...
export default connect(mapState, mapDispatch)(SingleBenefits AdministrationPage);
