...
const Employee Self Service PortalCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        ...
        setLoading(true);
        try {
            const result = await client.service("Employee Self Service Portal").patch(_entity._id, _data);
            props.onHide();
    ...
    return (
        <Dialog header="Edit Info" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div role="Employee Self Service Portal-edit-dialog-component">
                <div>
            ...
            <div>
                ...
                <InputText className="w-full mb-3" value={_entity?.profile} onChange={(e) => setValByKey("profile", e.target.value)}  />
            </div>
            <div>
                <p className="m-0">Updates :</p>
                <InputText className="w-full mb-3" value={_entity?.updates} onChange={(e) => setValByKey("updates", e.target.value)}  />
            </div>
            <div>
            ...
            <div>
                ...
                <InputText className="w-full mb-3" value={_entity?.payroll} onChange={(e) => setValByKey("payroll", e.target.value)}  />
            </div>
            <div>
            ...
            <div>
                ...
                <InputText className="w-full mb-3" value={_entity?.access} onChange={(e) => setValByKey("access", e.target.value)}  />
            </div>
...
export default connect(null, mapDispatch)(Employee Self Service PortalCreateDialogComponent);
