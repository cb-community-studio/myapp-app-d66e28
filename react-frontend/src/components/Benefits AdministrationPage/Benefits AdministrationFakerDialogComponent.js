...
import Benefits AdministrationFakerFactory from "./Benefits AdministrationFakerFactory";
...
const Benefits AdministrationFakerDialogComponent = (props) => {
    ...
    const onRun = async () => {
        let fakeData = Benefits AdministrationFakerFactory(fakerCount);

        setLoading(true);
        const promises = fakeData.map((elem) => client.service("Benefits Administration").create(elem));
...
export default connect(null, mapDispatch)(Benefits AdministrationFakerDialogComponent);
