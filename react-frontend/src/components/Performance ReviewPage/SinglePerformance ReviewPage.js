...
const SinglePerformance ReviewPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singlePerformance ReviewId, { query: { $populate: [] }})
            .then((res) => {
                set_entity(res || {});
    ...
    const goBack = () => {
        navigate("/Performance Review", { replace: true });
    };
    return (
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                <div className="flex align-items-center justify-content-start">
                    ...
                    <h3 className="m-0">Performance Review</h3>
                </div>
                <p>Performance Review/{urlParams.singlePerformance ReviewId}</p>
            </div>
...
export default connect(mapState, mapDispatch)(SinglePerformance ReviewPage);
