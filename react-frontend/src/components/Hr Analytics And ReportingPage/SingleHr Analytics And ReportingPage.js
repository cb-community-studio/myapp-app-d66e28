...
const SingleHr Analytics And ReportingPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleHr Analytics And ReportingId, { query: { $populate: [] }})
            .then((res) => {
                set_entity(res || {});
    ...
    const goBack = () => {
        navigate("/Hr Analytics And Reporting", { replace: true });
    };
    return (
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                <div className="flex align-items-center justify-content-start">
                    ...
                    <h3 className="m-0">Hr Analytics And Reporting</h3>
                </div>
                <p>Hr Analytics And Reporting/{urlParams.singleHr Analytics And ReportingId}</p>
            </div>
...
export default connect(mapState, mapDispatch)(SingleHr Analytics And ReportingPage);
