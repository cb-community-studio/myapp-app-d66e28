...
const SingleCompliance And DocumentsPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleCompliance And DocumentsId, { query: { $populate: [] }})
            .then((res) => {
                set_entity(res || {});
    ...
    const goBack = () => {
        navigate("/Compliance And Documents", { replace: true });
    };
    return (
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                <div className="flex align-items-center justify-content-start">
                    ...
                    <h3 className="m-0">Compliance And Documents</h3>
                </div>
                <p>Compliance And Documents/{urlParams.singleCompliance And DocumentsId}</p>
            </div>
...
export default connect(mapState, mapDispatch)(SingleCompliance And DocumentsPage);
