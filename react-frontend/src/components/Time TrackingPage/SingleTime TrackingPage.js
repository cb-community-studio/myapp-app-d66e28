...
const SingleTime TrackingPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleTime TrackingId, { query: { $populate: [] }})
            .then((res) => {
                set_entity(res || {});
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                <div className="flex align-items-center justify-content-start">
                    ...
                    <h3 className="m-0">Time Tracking</h3>
                </div>
                <p>Time Tracking/{urlParams.singleTime TrackingId}</p>
            </div>
...
export default connect(mapState, mapDispatch)(SingleTime TrackingPage);
