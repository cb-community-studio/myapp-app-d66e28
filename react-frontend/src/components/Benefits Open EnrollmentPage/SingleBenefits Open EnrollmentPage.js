...
const SingleBenefits Open EnrollmentPage = (props) => {
    ...
    useEffect(() => {
        //on mount
        client
            .service("Benefits Open Enrollment")
            .get(urlParams.singleBenefits Open EnrollmentId, { query: { $populate: [] }})
            .then((res) => {
                set_entity(res || {});
            ...
            .catch((error) => {
                console.log({ error });
                props.alert({ title: "Benefits Open Enrollment", type: "error", message: error.message || "Failed get Benefits Open Enrollment" });
            });
    }, []);
    ...
    const goBack = () => {
        navigate("/Benefits Open Enrollment", { replace: true });
    };
    return (
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                <div className="flex align-items-center justify-content-start">
                    ...
                    <h3 className="m-0">Benefits Open Enrollment</h3>
                </div>
                <p>Benefits Open Enrollment/{urlParams.singleBenefits Open EnrollmentId}</p>
            </div>
...
export default connect(mapState, mapDispatch)(SingleBenefits Open EnrollmentPage);
