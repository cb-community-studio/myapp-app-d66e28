...
import Offboarding TerminationFakerFactory from "./Offboarding TerminationFakerFactory";
...
const Offboarding TerminationFakerDialogComponent = (props) => {
    ...
    const onRun = async () => {
        let fakeData = Offboarding TerminationFakerFactory(fakerCount);

        setLoading(true);
        const promises = fakeData.map((elem) => client.service("Offboarding Termination").create(elem));
...
export default connect(null, mapDispatch)(Offboarding TerminationFakerDialogComponent);
