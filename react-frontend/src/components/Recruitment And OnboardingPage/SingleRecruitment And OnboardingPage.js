...
const SingleRecruitment And OnboardingPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleRecruitment And OnboardingId, { query: { $populate: [] }})
            .then((res) => {
                set_entity(res || {});
    ...
    const goBack = () => {
        navigate("/Recruitment And Onboarding", { replace: true });
    };
    return (
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                <div className="flex align-items-center justify-content-start">
                    ...
                    <h3 className="m-0">Recruitment And Onboarding</h3>
                </div>
                <p>Recruitment And Onboarding/{urlParams.singleRecruitment And OnboardingId}</p>
            </div>
...
export default connect(mapState, mapDispatch)(SingleRecruitment And OnboardingPage);
