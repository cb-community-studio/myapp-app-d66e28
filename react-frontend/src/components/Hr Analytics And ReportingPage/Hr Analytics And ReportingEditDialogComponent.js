...
const Hr Analytics And ReportingCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        ...
        setLoading(true);
        try {
            const result = await client.service("Hr Analytics And Reporting").patch(_entity._id, _data);
            props.onHide();
    ...
    return (
        <Dialog header="Edit Info" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div role="Hr Analytics And Reporting-edit-dialog-component">
                <div>
...
export default connect(null, mapDispatch)(Hr Analytics And ReportingCreateDialogComponent);
